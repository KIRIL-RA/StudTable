...
async function handler(req, res) {
    ...
    try {
        ...
        await academy.Init();
        let notConfirmedAccounts = await academy.GetUnconfirmedAccounts(userData.academy.directionId, userData.academy.course, userData.academy.group, AccountTypes.STUDENT);
...
var __webpack_exports__ = __webpack_require__.X(0, [805,442,341,749], () => (__webpack_exec__(8985)));
